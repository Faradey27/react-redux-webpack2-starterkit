...
*Based on [Airbnb](http://airbnb.io/javascript/)*
...
## Whitespace
  ...
  - [18.12](#whitespace--max-len) Avoid having lines of code that are longer than 100 characters (including whitespace). Note: per [above](#strings--line-length), long strings are exempt from this rule, and should not be broken up. eslint: [`max-len`](http://eslint.org/docs/rules/max-len.html) jscs: [`maximumLineLength`](http://jscs.info/rule/maximumLineLength)
    ...
    // bad
    $.ajax({ method: 'POST', url: 'https://bla.com/', data: { name: 'John' } }).done(() => console.log('Congratulations!')).fail(() => console.log('You have failed this city.'));
...
## Type Casting & Coercion
  ...
  - [21.5](#coercion--bitwise) **Note:** Be careful when using bitshift operations. Numbers are represented as [64-bit values](https://es5.github.io/#x4.3.19), but bitshift operations always return a 32-bit integer ([source](https://es5.github.io/#x11.7)). Bitshift can lead to unexpected behavior for integer values larger than 32 bits. [Discussion](https://github.com//javascript/issues/109). Largest signed 32-bit Int is 2,147,483,647:
...
## Testing
  ...
  - [28.2](#testing--for-real) **No, but seriously**:
   ...
   - We primarily use [`mocha`](https://www.npmjs.com/package/mocha) at bla. [`tape`](https://www.npmjs.com/package/tape) is also used occasionally for small, separate modules.
...
**Tools**
  ...
  - Code Style Linters
    + [ESlint](http://eslint.org/) - [ Style .eslintrc](https://github.com//javascript/blob/master/linters/.eslintrc)
    + [JSHint](http://jshint.com/) - [ Style .jshintrc](https://github.com//javascript/blob/master/linters/.jshintrc)
    + [JSCS](https://github.com/jscs-dev/node-jscs) - [ Style Preset](https://github.com/jscs-dev/node-jscs/blob/master/presets/bla.json)
